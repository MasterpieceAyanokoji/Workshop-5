...
Чем меньше коээфицент корреляции, тем лучше и быстрее обучится модель, так как в данном случае он является строгой верхней границей, определяющей вознаграждение. Однако, уменьшение данного параметра может сильно увеличить время обучения модели
